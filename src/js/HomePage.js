    ...
    return (
        <div className="min-h-screen bg-gray-100">
            ...
            <section className="text-center py-16 bg-blue-500 text-white">
                <h1 className="text-4xl font-bold mb-4">Luyện tập tiếng Anh mỗi ngày với bài tập nghe - chép chính tả</h1>
                <p className="text-lg mb-6">Cách nhanh nhất để nâng cao kỹ năng nghe và phát âm của bạn!</p>
                <button className="bg-white text-blue-500 px-6 py-3 rounded-md font-bold hover:bg-gray-200">Bắt đầu ngay</button>
            </section>
            ...
            <section className="text-center py-12 bg-gray-100">
                ...
                <button className="bg-blue-500 text-white px-6 py-3 rounded-md font-bold hover:bg-blue-600">Bắt đầu học ngay</button>
            </section>
        </div>
    );
};
